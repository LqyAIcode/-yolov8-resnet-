...
class ClassificationModel(nn.Module):
    def __init__(self, num_classes):
        ...
        # in_features = resnet.classifier.in_features
        # print(resnet)
...
if __name__ == '__main__':
    ...
    classification_model = ResNeXtClassification(num_classes=2)
    regression_model = ResNeXtClassification(num_classes=1)
    ...
    # 保存分类模型和回归模型的权重
    torch.save(classification_model.state_dict(), 'classification_model_1_contrast.pth')
    torch.save(regression_model.state_dict(), 'regression_model_1_contrast.pth')
    '''
